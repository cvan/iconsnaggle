...
module.exports.getBestIcons = getBestIcons = function getBestIcons(icons) {
    var largest = {};
...
module.exports.getBestIcon = getBestIcon = function getBestIcon(icons) {
    icons = getBestIcons(icons);
